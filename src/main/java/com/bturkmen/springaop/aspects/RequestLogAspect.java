...
public class RequestLogAspect {
    ...
    public void log3(final JoinPoint joinPoint) throws Throwable {
    	String method = joinPoint.getSignature().getName();
    	log.info("BEFORE : "+method);
    }
    
    @After("@annotation(org.springframework.web.bind.annotation.RequestMapping) && execution(public * *(..))")
    public void log2(final JoinPoint joinPoint) throws Throwable {
    	String method = joinPoint.getSignature().getName();
